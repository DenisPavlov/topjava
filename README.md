[![Build Status](https://travis-ci.org/DenisPavlov/topjava.svg?branch=master)](https://travis-ci.org/DenisPavlov/topjava)
...
- добавить flyway
- добавить docker
- для тестирования репозитория dbRider
- прикрутить Elastic Search
- test containers